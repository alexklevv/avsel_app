...
import {Card, Col, Row, Typography, Modal, Form, Input, Divider} from "antd";
...
const Complaints = (props) => {
    return (
        <div className="site-layout-content">
            <Title level={5} style={{marginBottom: '20px'}}>1 complain</Title>
            <Row gutter={[16, 24]}>
                {
                    [2].map((value) => {
                            ...
                            >
                                ...
                                >
                                    <Row gutter={[0, 8]}>
                                        ...
                                        <Divider/>
                                        <Col span={24} className="gutter-row">
                                            <Text>Complaint: I want to report that the seller of this car is a scammer! Selling non-existent cars!</Text>
                                        </Col>
                                    </Row>
                                </Card>
                            </Col>
