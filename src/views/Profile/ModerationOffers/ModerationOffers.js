...
import {DeleteOutlined, EditOutlined, HeartOutlined, StopOutlined} from "@ant-design/icons";
...
const ModerationOffers = () => {
    ...
    return (
        <div className="site-layout-content">
            ...
            <Title level={5} style={{marginBottom: '20px'}}>Offers on moderation: {offers ? offers.length : ''}</Title>
            <Row gutter={[16, 24]}>
...
export default ModerationOffers;